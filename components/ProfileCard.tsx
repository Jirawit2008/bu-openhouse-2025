...
const ProfileCard: React.FC = () => {
    ...
    const socialLinks = [
        ...
        {
            name: 'Facebook',
            href: 'https://facebook.com/JirawitDuangjantakhot',
            icon: (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
        ...
        {
            name: 'Instagram',
            href: 'https://instagram.com/first9op',
            icon: (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="p-4 sm:p-6 lg:p-8 flex flex-col justify-center items-center text-center">
                    ...
                    <div className="mb-4">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-center justify-center">
                            <div className="flex items-center space-x-2">
                                ...
                                <div>
                                    <p className="text-white font-medium text-sm sm:text-base">itemfirst52@gmail.com</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <div>
                                    <p className="text-white font-medium text-sm sm:text-base">+66 (093) 659-0849</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="max-w-xl mb-2">
                        <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                            Hello, I'm Jirawit Duangjantakhot. My nickname is First. I'm 17 year old. I study in Valaya Alongkorn Rajaphat University Demonstration School under royal patronage (VRU)
